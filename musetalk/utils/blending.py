...
def get_mask_image(face_large, face_box, crop_box, upper_boundary_ratio):
    x, y, x1, y1 = face_box
...
def get_image(image, face, face_box, upper_boundary_ratio=0.5, expand=1.2):
    ...
    mask_image = get_mask_image(face_large, face_box, crop_box, upper_boundary_ratio)
...
def blend_images(face_large, body, mask_array, crop_box):
    x, y, x1, y1 = face_box
    x_s, y_s, x_e, y_e = crop_box
...
def get_image_blending(image, face, face_box, mask_array, crop_box):
    ...
    body = blend_images(face_large, body, mask_array, crop_box)
    return body
